...
# Define the coins, contract types, and base symbols for COINM
coins = ["ADA", "BNB", "ETH", "LINK", "XRP", "DOT", "BTC", "TRX"]
base_symbols = ["USD"]
...
funding_history_url = "https://dapi.binance.com/dapi/v1/fundingRate"
